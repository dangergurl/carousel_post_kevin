...
class TikTokStyleTextOverlay:
    ...
    def __init__(self):
        ...
        self.font_size = 52  # Reduced by 20% (was 65px) ✓
        self.font_path = "/app/ProximaNovaSemibold.otf"  # Proxima Nova font ✓
        self.outline_width = 4  # Perfect outline thickness ✓
    ...
    def _wrap_text_for_tiktok(self, text: str) -> list:
        ...
        lines = []
        current_line = ""
        max_chars_per_line = 22  # Consistent character length for visual balance
